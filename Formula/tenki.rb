class Tenki < Formula
  ...
  homepage "https://github.com/OWNER/tenki"
  url "https://github.com/OWNER/tenki/archive/refs/tags/v0.1.0.tar.gz"
  sha256 "REPLACE_WITH_TARBALL_SHA256"
  license "MIT"
  head "https://github.com/OWNER/tenki.git", branch: "main"
